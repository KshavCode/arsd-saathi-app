...
const styles = StyleSheet.create({
    container: { flex: 1, backgroundColor: "#f1f6ff" },
    ...
    card: { backgroundColor: "#FFF", borderRadius: 20, padding: 25, elevation: 10, shadowColor: "#000", shadowOpacity: 0.1, shadowRadius: 10 },
