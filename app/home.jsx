		  ...
		  <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
			...
			<View style={[styles.heroContainer, { backgroundColor: theme.card, borderColor: theme.primary+'50' }]}>
				...
				<View style={styles.actionsGrid}>
					...
					<GridActionButton title="What's New?" icon="build" onPress={() => navigation.navigate("Whatsnew")} theme={theme} />
					<GridActionButton title="FAQs" icon="reorder-four" onPress={() => navigation.navigate("Faq")} theme={theme} />
