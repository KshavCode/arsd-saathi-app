# ⚖️ Terms of Use
By using ArsdSaathi, you agree to the following terms. This document is designed to protect both you (the student) and us (the developers).

### 1. Independent Service
- **Non-Official**: ArsdSaathi is an independent utility tool. It is not an official application of Atma Ram Sanatan Dharma College or its administration.
- **No Affiliation**: This app is built by students to improve the mobile experience of accessing student data. Use of this app does not replace the official college portal.

### 2. Information Accuracy
- **Data Source**: All information (attendance, profile, faculty) is fetched directly from the official college portal.
- **Verification**: We are not responsible for errors or discrepancies in the original portal data. For official records, please always refer to the college administration or the web portal.

### 3. App Stability & Updates
